 ...
 */
package com.daphne.lazulite.maintain.icon.web.controller;
...
import com.daphne.lazulite.maintain.icon.entity.Icon;
import com.daphne.lazulite.maintain.icon.entity.IconType;
import com.daphne.lazulite.maintain.icon.service.IconService;
...
//                .addSearchParam("type_in", new IconType[]{IconType.upload_file, IconType.css_sprite});
        ...
        List<Icon> iconList = baseService.findAll();
