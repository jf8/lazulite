 ...
 */
package com.daphne.lazulite.personal.calendar.web.controller;
...
import com.daphne.lazulite.personal.calendar.service.CalendarService;
...
public class CalendarController extends BaseController<Calendar, Long> {
    ...
    @RequestMapping("/load")
    @ResponseBody
    public Collection<Map> ajaxLoad(Pageable pageable, @CurrentUser User loginUser) {
        //pageable.addSearchParam("userId_eq", loginUser.getId());
