INSERT INTO SYS_USER (id, username, email, mobile_phone_number, password, salt, create_date, status, deleted, admin) VALUES ('1', 'admin', 'junfu.chen@daphne.com.cn', '15036092123', 'd80887e569dd1bceff045a84473642e8', 'yDd1956wn1',  sysdate(), 'normal', '0', '1');
INSERT INTO SYS_USER (id, username, email, mobile_phone_number, password, salt, create_date, status, deleted, admin) VALUES ('2', 'user', 'user@daphne.com.cn', '15036092124', '74f30840447c1d77fa37d836ff56125b', 'hSSixwNQwt',  sysdate(), 'normal', '0', '1');
INSERT INTO SYS_USER (id, username, email, mobile_phone_number, password, salt, create_date, status, deleted, admin) VALUES ('3', 'sys', 'sys@daphne.com.cn', '15036092125', '2b3bdb1759da40845752b738e911532e', 'MANHOoCpnb',  sysdate(), 'normal', '0', '1');
INSERT INTO SYS_USER (id, username, email, mobile_phone_number, password, salt, create_date, status, deleted, admin) VALUES ('4', 'maintain', 'maintain@sishuok.com', '15036092126', 'b8ffd9510a16ab04563b753ce353e5b5', 'iY71e4dtoa',  sysdate(), 'normal', '0', '1');
